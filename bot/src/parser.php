...
function skolnichDnuOdDo($vych_datum, $kon_datum = 99999999) {
    ...
    $prazdniny = array(
        20220928, 20221026, 20221027, 20221028, 20221117,
        20221223, 20221226, 20221227, 20221228, 20221229, 20221230, 20230102,
        20230203, 20230306, 20230307, 20230308, 20230309, 20230310,
        20230406, 20230407, 20230410, 20230501, 20230508, 20230701
    );
    $pocitadlo = 0;
    $datum = $vych_datum;
